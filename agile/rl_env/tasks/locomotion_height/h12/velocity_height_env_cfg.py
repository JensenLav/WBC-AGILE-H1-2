...
class MySceneCfg(InteractiveSceneCfg):
    ...
    # robots
    robot = unitree_h12.H1_2_27DOF.replace(prim_path="{ENV_REGEX_NS}/Robot")
...
class CommandsCfg:
    ...
    base_velocity = mdp.UniformVelocityBaseHeightCommandCfg(
        ...
        debug_vis=True,
        default_height=unitree_h12.DEFAULT_PELVIS_HEIGHT,
        ...
        ranges=mdp.UniformVelocityBaseHeightCommandCfg.Ranges(
            ...
            base_height=(0.5, unitree_h12.DEFAULT_PELVIS_HEIGHT),
        ),
        min_walk_height=0.75,
...
class RewardsCfg:
    ...
    dof_pos_limits = RewTerm(
        ...
        weight=-1.0,
        params={"asset_cfg": SceneEntityCfg("robot", joint_names=unitree_h12.LEG_JOINT_NAMES)},
    )
    dof_vel_limits = RewTerm(
        func=mdp.joint_vel_limits,
        weight=-1.0,
        params={"soft_ratio": 0.9, "asset_cfg": SceneEntityCfg("robot", joint_names=unitree_h12.LEG_JOINT_NAMES)},
    )
    dof_vel_l2 = RewTerm(
    ...
    relax_if_null_cmd = RewTerm(
        ...
        params={
            "command_name": "base_velocity",
            "std": 0.25,
            "asset_cfg": SceneEntityCfg("robot", joint_names=unitree_h12.LEG_JOINT_NAMES),
        },
    )
...
class TerminationsCfg:
    ...
    feet_distance = DoneTerm(
        ...
        params={
            "asset_cfg": SceneEntityCfg("robot", body_names=".*ankle_roll_link"),
            "min_distance_threshold": 0.167,  # six seven
    ...
    randomize_upper_actuator_gains = EventTerm(
        ...
        params={
            "asset_cfg": SceneEntityCfg(
                "robot", joint_names=unitree_h12.ARM_JOINT_NAMES + unitree_h12.WAIST_JOINT_NAMES
            ),
...
@configclass
class H12LowerVelocityHeightEnvCfg(ManagerBasedRLEnvCfg):
...
@configclass
class H12VelocityHeightRecurrentStudentEnvCfg(H12LowerVelocityHeightEnvCfg):
...
@configclass
class H12VelocityHeightHistoryStudentEnvCfg(H12VelocityHeightRecurrentStudentEnvCfg):
    """Configuration for the student distillation locomotion velocity-tracking environment."""
